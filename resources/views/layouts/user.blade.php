...
<head>
  <meta charset="utf-8">
  <title>Nara Potensia - Biro Psikologi</title>
...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="#hero">
          <img src="{{asset('user/images/logoutama.png')}}" style="margin-right:5px; max-width: 50px;"/></img>
        </a>
      </div>
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="{{$url=='destination'?'menu-active':''}}"><a href="{{url('destination')}}">Produk</a></li>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>Nara Potensia</strong>. All Rights Reserved
      </div>
      <div class="credits">
