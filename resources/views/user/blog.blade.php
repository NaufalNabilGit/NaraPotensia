...
@section('header')
    <style>
        #hero{
            background: url('{{asset('user/images/artikel.jpg')}}') top center;
...
@section('hero')
    <h1>Artikel Nara Potensia - Biro Psikologi </h1>
    <h2>Kumpulan artikel-artikel Psikologi terkini dan terupdate</h2>
@endsection
        ...
        <div class="container wow fadeIn">
          ...
          <div class="row">
            ...
            <div class="col-3">
                ...
                <div class="mb-3 font-weight-bold">Artikel Terakhir</div>
