...
@section('hero')
    <h1>Nara Potensia - Biro Psikologi</h1>
    <h2>Kami adalah penyedia segala jenis kebutuhan alat tes Psikologi no.1 di Indonesia</h2>
        ...
        <div class="container">
          <div class="row about-container">
            ...
            <div class="col-lg-5 background order-lg-2 order-1 wow fadeInRight" 
                style="background: url('{{asset('user/images/about.jpg')}}') center top no-repeat; background-size: cover;"></div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
              <div class="box">
                ...
                <h4 class="title">Cepat Tepat Akurat</h4>
