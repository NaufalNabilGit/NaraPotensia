...
@section('header')
    <style>
        #hero{
            background: url('{{asset('user/images/produk.jpg')}}') top center;
...
@section('hero')
    <h1>Produk Nara Potensia-Biro Psikologi</h1>
    <h2>Cek segala alat tes yang kami miliki dan tentukan sesuai kebutuhan anda</h2>
@endsection
            ...
            <div class="col-sm-3 mt-5">
              <form action="{{route('destination')}}" class="mt-5">
                <div class="input-group mb-4 border rounded-pill shadow-lg" style="border-radius:10px; box-shadow: 3px 3px 8px grey;">
                  <input type="text" name="s" value="{{Request::get('s')}}" placeholder="Cari Produk" class="form-control bg-none border-0" style="border-top-left-radius: 10px; border-bottom-left-radius: 10px;">
                  <div class="input-group-append border-0">
                    <button type="submit" class="btn text-success"><i class="fa fa-search"></i></button>
                  </div>
                </div>
              </form>
              <div class="mb-3 font-weight-bold">Produk Lainnya</div>
